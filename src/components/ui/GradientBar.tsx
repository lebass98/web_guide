        ...
        >
          ...
          <div
            ...
            className={cn(
              ...
              activeStopId === stop.id ? "border-zinc-800 z-30 scale-105" : "border-zinc-400 z-10 hover:border-zinc-500"
            )}
          >
            <div 
          ...
          <div className="absolute top-[52px] left-1/2 -translate-x-1/2 w-10">
            ...
            <div className={cn(
              ...
              activeStopId === stop.id ? "border-zinc-800 text-zinc-900" : "border-zinc-200 text-zinc-600"
            )}>
              {stop.position}
            </div>
          </div>
