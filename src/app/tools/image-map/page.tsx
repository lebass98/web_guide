        ...
        <>
            ...
            <div className="flex flex-col lg:flex-row gap-8 lg:max-h-[calc(100vh-250px)]">
                ...
                <div className="w-full lg:w-[350px] flex flex-col gap-4 overflow-y-auto pr-2 custom-scrollbar">
                    ...
                    {/* Real-time Code Preview (Right Side) */}
                    <div className="glass-card bg-zinc-950 rounded-2xl overflow-hidden shadow-2xl border border-white/5 relative flex flex-col">
                        <div className="flex items-center justify-between px-4 py-3 border-b border-white/5">
                            ...
                            <button
                                ...
                                className="flex items-center gap-1.5 px-3 py-1.5 bg-fuchsia-500 hover:bg-fuchsia-600 text-white rounded-lg text-xs font-bold shadow-lg transition-all active:scale-95 group"
                            >
                                <Copy className="w-3 h-3 group-hover:scale-110 transition-transform" />
                                복사
                            </button>
                        </div>
                        <pre className="p-4 font-mono text-[11px] overflow-auto text-fuchsia-400/90 selection:bg-fuchsia-500/30 leading-relaxed max-h-[320px] custom-scrollbar whitespace-pre-wrap break-all">
                            {generateCode()}
                        </pre>
                    </div>
